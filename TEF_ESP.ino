...
********************************************************************************
  ...
  Originally made by:
  (c) 2023 Sjef Verhoeven pe5pvb@het-bar.net (https://www.pe5pvb.nl/tef6686)
  Based on Catena / NXP semiconductors API
********************************************************************************

Modified by Hyper DX to work with original PE5PVB project * * * fork of Noobish's version dedicated to Chinese version of tuner
Mod: https://github.com/HyperDX/TEF_ESP
Forked from: https://github.com/NoobishSVK/TEF6686-remastered
*/
...
#define BWINTERVAL 500 // Refresh interval for certain UI elements 
//#define ARS       // uncomment for BGR type display (ARS version)

#ifdef ARS
#define VERSION "v1.21.1ARS"
#include "TFT_Colors.h"
TFT_eSPI tft = TFT_eSPI(320, 240);
#else
#define VERSION "v1.21.1"
...
void setup() {
  ...
  tft.drawRightString("Forked by Hyper DX", 310, 205, 2);
  tft.drawRightString("Original mod by Noobish.eu", 310, 220, 2);
      ...
      switch (menuoption) {
        ...
        case 150:
          if (power == false) {
            ...
            tft.drawCentreString("Press POWER button to wake up", 150, 95, 2);
            delay(1000);
            power = false;
            menu2 = false;
